              ...
              <td *ngFor="let col of columns">
                <ng-container [ngSwitch]="col.type">
                  ...
                  <div *ngSwitchCase="'action'" class="action-buttons" (click)="$event.stopPropagation()">
                    ...
                    <!-- View button for students and teachers -->
                    <button class="btn-icon view" *ngIf="row.studentCode || row.subjectsList !== undefined || row.staffCode" (click)="$event.stopPropagation(); actionClicked.emit({ action: 'view', row: row })" title="View Details">👁️</button>
